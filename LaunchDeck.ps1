...
function Add-SideButton {
    ...
    if (-not [string]::IsNullOrWhiteSpace($IconUrl)) {
        try {
            ...
            $imageStream = $webClient.OpenRead($IconUrl)
...
Add-SideButton -Name "Set Boot Name" -Code {
    ...
    $BootForm.Size = New-Object System.Drawing.Size(350, 200);$BootForm.StartPosition = "CenterParent";
    ...
    $RadioDefault.Location = New-Object System.Drawing.Point(20, 20);$RadioDefault.Size = New-Object System.Drawing.Size(300, 20);
    ...
    $RadioCustom.Location = New-Object System.Drawing.Point(20, 50);$RadioCustom.Size = New-Object System.Drawing.Size(70, 20);
    $BootForm.Controls.Add($RadioCustom);

    # TextBox: Custom Name
    $TextBoxCustom = New-Object System.Windows.Forms.TextBox;
    $TextBoxCustom.Location = New-Object System.Drawing.Point(90, 50);$TextBoxCustom.Size = New-Object System.Drawing.Size(210, 20);
    ...
    $ApplyBtn.Text = "Apply";
    $ApplyBtn.Location = New-Object System.Drawing.Point(80, 110);$ApplyBtn.DialogResult = [System.Windows.Forms.DialogResult]::OK;
    $BootForm.Controls.Add($ApplyBtn);

    # Cancel Button
    $CancelBtn = New-Object System.Windows.Forms.Button;
    $CancelBtn.Text = "Cancel";
    $CancelBtn.Location = New-Object System.Drawing.Point(180, 110);$CancelBtn.DialogResult = [System.Windows.Forms.DialogResult]::Cancel;
    ...
    if ($result -eq [System.Windows.Forms.DialogResult]::OK) {
        $newName = if ($RadioCustom.Checked -and -not [string]::IsNullOrWhiteSpace($TextBoxCustom.Text)) {$TextBoxCustom.Text;
        } else {
            $defaultName;
        };
